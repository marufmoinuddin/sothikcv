    ...
    <>
      <FeatureCard>
        ...
        <p className="text-xl mr-14">
          Personalize using <strong>templates and themes</strong>!
        </p>
      </FeatureCard>
      <FeatureCard>
        <CardPinnnedIcon>
        ...
        <p className="text-xl mr-14">
          Intuitive <strong>interface</strong> facilitating quick building!
        </p>
      </FeatureCard>
      <FeatureCard>
        <CardPinnnedIcon>
        ...
        <p className="text-xl mr-14">
          Start building without <strong>signing up</strong> — no registration required!
        </p>
      </FeatureCard>
      <FeatureCard>
        <CardPinnnedIcon>
        ...
        <p className="text-xl mr-14">
          Your <strong>information</strong> remains on your device for enhanced security.
        </p>
      </FeatureCard>
    </>
  );
